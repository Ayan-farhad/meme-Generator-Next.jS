    ...
    return (
        <div style={{ fontFamily: "Arial, sans-serif", padding: "20px" }}>
            ...
            <div style={{ marginTop: "20px", textAlign: "center" }}>
                <input type="text" placeholder="Enter meme first text" onChange={e => setText1(e.target.value)} style={{ padding: "8px", marginRight: "10px", borderRadius: "4px", border: "1px solid #ccc" }} />
                <input type="text" placeholder="Enter meme second text" onChange={e => setText2(e.target.value)} style={{ padding: "8px", marginRight: "10px", borderRadius: "4px", border: "1px solid #ccc" }} />
